...
describe('Notes view', () => {
  ...
  xit('clicks the button and displays a new note', () => {
    const model = new NotesModel();
  ...
  xit('clears all existing notes before displaying', () => {
    const model = new NotesModel();
    const view = new NotesView(model);
  ...
  xit('clicks the button twice, displays two new notes, clears text input', () => {
    const model = new NotesModel();
    const view = new NotesView(model);
  ...
  xit('displays notes from an API', () => {
    const model = new NotesModel();
    const fakeClient = {
      loadNotes: (callback) => {
